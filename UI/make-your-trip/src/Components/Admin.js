...
import React, { useState, useEffect } from 'react';
import { Modal, Box, Container, Grid, Typography, TextField, Button } from '@mui/material';
...
const Admin = () => {
  ...
  return (
    <>
      <div>
        <Button variant="contained" color="primary" onClick={() => setModalIsOpen(true)}>Open Popup</Button>
        <Popup
          modalIsOpen={modalIsOpen}
          setModalIsOpen={setModalIsOpen}
          handleFileChange={handleFileChange}
